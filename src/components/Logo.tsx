const Logo = ({ className = "" }: { className?: string }) => {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <div className="relative w-12 h-12 border-2 border-foreground flex items-center justify-center gap-3">
        ...
        <span className="text-2xl font-serif font-bold text-foreground">S</span>
      </div>
